    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 p-5 flex items-center justify-center z-50">
      ...
      <form onSubmit={handleAddBook}>
        <div className="mb-4">
          ...
          <input type="text" value={title} onChange={(e)=>setTitle(e.target.value)} placeholder="Book Title" className="w-full px-4 py-2 border-2 border-black rounded-md" required/>
        </div>
        ...
        <div className="mb-4">
          ...
          <textarea value={description} onChange={(e)=> setDescription(e.target.value)} placeholder="Book's Description" row={4} className="w-full px-4 py-2 border-2 border-black rounded-md"/>
          </div>
