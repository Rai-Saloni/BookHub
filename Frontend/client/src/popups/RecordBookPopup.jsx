  ...
  return (
    ...
    <form onSubmit={handleRecordBook}>
      <div className="mb-4">
        ...
        <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} placeholder="Borrower's Email" className="w-full px-4 py-2 border-2 border-black rounded-md" required/>
      </div>
