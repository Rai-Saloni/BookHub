...
},[message,isAuthenticated,error,dispatch]);
   ...
   <div className="flex flex-col justify-center md:flex-row h-screen">
    ...
    <div className="max-w-sm w-full">
      ...
      <form onSubmit={handleOtpVerification}>
        <div className="mb-4">
          <input type="number" value={otp} onChange={(e)=>setOtp(e.target.value)} placeholder="OTP" className="w-full px-4 py-3 border-black-rounded-md focus:outline-none border"></input>
        </div>
