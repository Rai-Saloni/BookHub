...
<form onSubmit={handleForgotPassword}>
  <div className="mb-4">
  <input type="email"  required value={email} onChange={(e)=>setEmail(e.target.value)} placeholder="Email" className="w-full px-4 py-3 border-black-rounded-md focus:outline-none border"></input>
  </div>
  <button><button type="submit" className="border-2 mt-5 border-black w-[380px] font-semibold py-3 rounded-lg  bg-black text-white hover:bg-white hover:text-black transition"
